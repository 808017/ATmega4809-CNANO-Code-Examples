...
FINAL_IMAGE=${DISTDIR}/ATmega4809_Push_Button.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/ATmega4809_Push_Button.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=ATmega4809
# ------------------------------------------------------------------------------------
# Rules for buildStep: compile
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/newmain.o: newmain.c  .generated_files/flags/default/9fe8f6a8ca40aaf73d2c3af32afe1d6ba48b9b1b .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/newmain.o: newmain.c  .generated_files/flags/default/4cce098d3264781f26dc1a135ec2f16be4c28ecc .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/newmain.o.d 
	@${RM} ${OBJECTDIR}/newmain.o 
...
${DISTDIR}/ATmega4809_Push_Button.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\avr-objcopy -O ihex "${DISTDIR}/ATmega4809_Push_Button.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "${DISTDIR}/ATmega4809_Push_Button.X.${IMAGE_TYPE}.hex"
